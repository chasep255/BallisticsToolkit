...
namespace btk::rendering
{
  ...
  class WindFlag
  {
     ...
     */
    WindFlag(float flag_base_width = 60.0f / 36.0f,
             float flag_tip_width = 24.0f / 36.0f,
             float flag_length = 16.0f / 3.0f,
             float flag_thickness = 0.05f,
             int flag_segments = 10,
             float flag_min_angle = 1.0f,
             float flag_max_angle = 90.0f,
             float flag_angle_response_k = 0.0205f,
             float flag_angle_interpolation_speed = 30.0f,
             float flag_direction_interpolation_speed = 1.0f,
             float flag_flap_frequency_base = 0.5f,
             float flag_flap_frequency_scale = 0.25f,
             float flag_flap_amplitude = 0.3f,
    ...
    // Helper methods
    void calculateFlagSegmentPosition(int segmentIndex,
                                     float angleDeg,
                                     float direction,
                                     float flapPhase,
                                     float& outX,
