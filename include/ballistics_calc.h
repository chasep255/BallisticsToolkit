...
public:
     ...
     */
    void setAtmosphere(double temperature_f, double pressure_inhg, 
     ...
     */
    void* calculateTrajectory(double muzzle_velocity_fps, double zero_range_yards, 
                             double scope_height_inches, double max_range_yards, 
                             double step_yards);
     ...
     */
    int getTrajectoryPoint(void* trajectory_data, double range_yards, 
                          double* drop_mrad, double* drift_mrad,
                          double* velocity_fps, double* energy_ftlbf, 
                          double* time_sec);
...
extern "C"
{
    ...
    void ballistics_calc_set_bullet(void* solver, double weight_grains, double diameter_inches, 
                                      double length_inches, double bc, int drag_function);
    ...
    void* ballistics_calc_calculate_trajectory(void* solver, double muzzle_velocity_fps, 
                                                 double zero_range_yards, double scope_height_inches, 
                                                 double max_range_yards, double step_yards);

    void ballistics_calc_free_trajectory(void* trajectory_data);
    
    int ballistics_calc_get_trajectory_point(void* trajectory_data, double range_yards, 
                                               double* drop_mrad, double* drift_mrad,
                                               double* velocity_fps, double* energy_ftlbf, 
                                               double* time_sec);
