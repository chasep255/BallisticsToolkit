// SettingsCookies.js - Cookie-based settings persistence for Steel simulator
...
export const SettingsCookies = {
  ...
  saveAll()
  {
    ...
    elements.forEach(element =>
    {
      ...
      if (settingName)
      {
        ...
        if (value !== '')
        {
          this.set(`steel_sim_${settingName}`, value);
        }
      }
    });
  },
  ...
  loadAll()
  {
    ...
    elements.forEach(element =>
    {
      ...
      if (settingName)
      {
        const value = this.get(`steel_sim_${settingName}`);
        if (value !== null)
        {
