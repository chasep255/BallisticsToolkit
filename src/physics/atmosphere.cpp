...
namespace btk
{
  namespace physics
  {
    ...
    Atmosphere::Atmosphere() : temperature_(btk::ballistics::Constants::TEMPERATURE_STANDARD_FAHRENHEIT), altitude_(0.0), humidity_(0.5), pressure_(calculateStandardPressure(0.0)) {}
    ...
    double Atmosphere::getAirDensity() const
    {
      ...
      constexpr double R_specific = btk::ballistics::Constants::GAS_CONSTANT_UNIVERSAL / btk::ballistics::Constants::MOLAR_MASS_DRY_AIR;
    ...
    double Atmosphere::getSpeedOfSound() const
    {
      ...
      double temperature_k = temperature_;
      double R_specific = btk::ballistics::Constants::GAS_CONSTANT_UNIVERSAL / btk::ballistics::Constants::MOLAR_MASS_DRY_AIR;

      double speed_of_sound = std::sqrt(btk::ballistics::Constants::HEAT_CAPACITY_RATIO_AIR * R_specific * temperature_k);
    ...
    Atmosphere Atmosphere::atAltitude(double altitude)
    {
      ...
      double temperature_k = btk::ballistics::Constants::TEMPERATURE_STANDARD_KELVIN + btk::ballistics::Constants::TEMPERATURE_LAPSE_RATE * altitude;
    ...
    double Atmosphere::calculateStandardPressure(double altitude) const
    {
      ...
      double pressure_pa = btk::ballistics::Constants::PRESSURE_STANDARD_PASCALS * std::exp(-altitude / btk::ballistics::Constants::PRESSURE_SCALE_HEIGHT);
