...
namespace btk::ballistics
{
    ...
    void NRATargets::initializeTargets()
    {
        ...
        targets_.emplace("SR-21",
                         Target("SR-21", Distance::inches(2.12), Distance::inches(4.12), Distance::inches(6.12),
                                Distance::inches(8.12), Distance::inches(10.12), Distance::inches(12.12),
                                Distance::inches(0.79), "100 yd simulation of 300 yd rapid"));

        // Mid Range (MR) Series
        targets_.emplace("MR-63",
                         Target("MR-63", Distance::inches(5.85), Distance::inches(8.85), Distance::inches(11.85),
                                Distance::inches(17.85), Distance::inches(23.85), Distance::inches(29.85),
                                Distance::inches(2.85), "300 yd slow fire (600 yd reduced)"));

        targets_.emplace("MR-65", Target("MR-65", Distance::inches(10.0), Distance::inches(15.0),
                                         Distance::inches(20.0), Distance::inches(25.0), Distance::inches(30.0),
                                         Distance::inches(36.0), Distance::inches(5.0), "500 yd slow fire"));
        ...
        targets_.emplace("MR-31",
                         Target("MR-31", Distance::inches(1.75), Distance::inches(2.75), Distance::inches(3.75),
                                Distance::inches(5.75), Distance::inches(7.75), Distance::inches(9.75),
                                Distance::inches(0.75), "100 yd simulation of 600 yd"));

        targets_.emplace("MR-52",
                         Target("MR-52", Distance::inches(3.79), Distance::inches(5.79), Distance::inches(7.79),
