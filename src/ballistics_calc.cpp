...
namespace btk::ballistics_calc
{
                                                    ...
                                                    double step_yards)
    {
        ...
        auto zeroing_result = Simulator::computeZeroedInitialState(*bullet_, mv, scope_height, zero_range, *atmosphere_,
                                                                   *wind_, timestep);
    ...
    extern "C"
    {
        ...
        {
            static_cast<BallisticsCalculator*>(solver)->initializeBullet(weight_grains, diameter_inches, length_inches,
                                                                         bc, drag_function);
        }
