...
- **Physics-Based Ballistics** - Modified point-mass trajectory simulation with G1/G7 drag models, wind presets, and Litz spin drift + crosswind jump. Muzzle velocity variation (MV σ) and rifle accuracy (MOA) model shot-to-shot spreads.
...
- **Spin Aerodynamics**: Modified point-mass trajectory with Bryan Litz's empirical spin-drift and crosswind-jump formulas, driven by the corrected Miller gyroscopic stability factor (SG); spin rate and SG from twist, muzzle velocity, and air density
